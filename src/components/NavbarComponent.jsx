  ...
  return (
    <div >
      <Navbar className="NB1" bg="dark-subtle" data-bs-theme="dark">
        <Container fluid>
          <Navbar.Brand className="fw-bold m-2" href="/">JReyes</Navbar.Brand>
        ...
        <Button >
              <Link to="https://www.linkedin.com/in/juanreyes11/" class="link-light"> 
            ...
            <Button className='m-2 btn btn-info'>
              <Link to="https://www.linkedin.com/in/juanreyes11/" class="link-dark">  
